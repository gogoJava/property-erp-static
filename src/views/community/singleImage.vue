  ...
  export default {
    ...
    methods: {
      ...
      async httpRequest(option) {
        ...
        const options = {
         // 设置axios的参数
         url: 'http://songsong.fun:8080/backstage/back/file/upload?type=7',
         data: formData,
         method: 'post',
         headers: {
        ...
        axios(options).then((res) => {
          ...
          this.fileList.push({ name: '文件', url: (this.imgPrefix + res.data.data.originalUrl) })
          ...
          this.list.push((this.imgPrefix + res.data.data.originalUrl))
