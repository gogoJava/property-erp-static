<template>
  <div class="upload-container-asset">
    <el-upload :file-list="fileList" :http-request="httpRequest" :on-remove="handleRemove" list-type="picture-card" action="http://songsong.fun/backstage/back/file/upload?type=4">
  ...
  export default {
    ...
    methods: {
      ...
      async httpRequest(option) {
        ...
        const options = {
         // 设置axios的参数
         url: 'http://songsong.fun/backstage/back/file/upload?type=4',
         data: formData,
         method: 'post',
         headers: {
