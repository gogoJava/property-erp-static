<template>
  <div class="upload-container">
    <el-upload :data="dataObj" :multiple="false" :show-file-list="false" :http-request="httpRequest" class="image-uploader" drag action="http://songsong.fun:8080/backstage/file/upload?type=3">
  ...
  export default {
    ...
    methods: {
      ...
      async httpRequest(option) {
        ...
        const options = {
         // 设置axios的参数
         url: 'http://songsong.fun:8080/backstage/file/upload?type=3',
         data: formData,
         method: 'post',
         headers: {
